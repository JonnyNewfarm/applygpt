...
const FindJobsLandingPage = () => {
  return (
    <main className="min-h-screen bg-[#2b2a27] border-white/80 dark:border-black/80 border-b-1 dark:bg-[#f5f4ef] text-[#f5f4ef] dark:text-[#2b2a27] px-6 sm:px-16 py-20 flex flex-col gap-y-20 items-center">
      {/* Intro Section */}
      <section className="w-full max-w-6xl mx-auto flex flex-col items-start text-left">
        <div className="flex flex-col text-left justify-start space-y-6">
          ...
          <Link
            href="/jobs"
            className="inline-block max-w-50 text-nowrap text-center bg-[#f5f4ef] dark:bg-[#2b2a27] dark:text-[#f5f4ef] text-[#2b2a27] px-6 py-3 rounded text-base  font-semibold hover:scale-105 transition"
          >
            Start Finding Jobs
          </Link>
        </div>

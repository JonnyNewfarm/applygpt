...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="w-full bg-transparent sticky top-0 left-0 z-50">
      ...
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-light shadow-lg z-60 transform transition-transform duration-300 ease-in-out
      ...
      {menuOpen && (
        <div
          className="fixed inset-0 bg-black/20 bg-opacity-40 z-50"
          onClick={() => setMenuOpen(false)}
          aria-hidden="true"
        />
      )}

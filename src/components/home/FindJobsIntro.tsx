...
export default function FindJobsIntro() {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="show"
      className="text-white  dark:text-black max-w-lg md:max-w-xl mx-auto text-left space-y-4 px-4 md:px-0"
    >
      <motion.h1
        variants={item}
      ...
      <motion.p variants={item} className="text-lg lg:text-xl opacity-80">
